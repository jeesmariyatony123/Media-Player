    ...
    <>
      <div className='container mt-5 mb-5'>
        <div className="d-flex justify-content-between">
          <h3>Watch History</h3>
          <Link to={'/home'} className='text-info text-decoration-none'> <i className='fa-solid fa-arrow-left '></i> Back To <i className=' fa-solid fa-home'></i> </Link>
        </div>
        <table className='table mt-5 mb-5'>
          <thead>
            <tr>
              ...
              <th>Video Link</th>
              <th>Time Stamp</th>
              <th><button className='btn'><i className='fa-solid fa-ellipsis-vertical'></i></button></th>
            </tr>
          </thead>
          <tbody>
